...
string Transfer::ConvertDataTransferToRecord(Client TransferFrom, Client TransferTo, float Amount, string seprator)
{
    string record = "";
...
void Transfer::SaveTransferingOperation(Client TransferFrom, Client TransferTo, float Amount, string seprator)
{
    fstream MyFile;
...
void Transfer::PrintTransfer(Client Sender, Client Receiver, float Amount)
{
    cout << "\n===============================\n";
...
void Transfer::ShowTransferScreen()
{
